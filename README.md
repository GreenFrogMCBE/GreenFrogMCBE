...
EasyProxy (https://github.com/Zwuiix-cmd/EasyProxy) - Used as an example for custom_form support (i had permission from repo owner)
BlueBird ( https://github.com/BlueBirdMC/Server/blob/main/test.js) (@Kanade-Giwi) - used as an example for test
```
