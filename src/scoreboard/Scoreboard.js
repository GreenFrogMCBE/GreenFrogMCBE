...
class Scoreboard {
    constructor() {
         ...
         */
        this.objectiveName = new Random().generateRandomString();
     ...
     */
    setScore(score, text, action = ScoreActions.UPDATE, entry_type = EntryTypes.TEXT, entity_unique_id = undefined) {
