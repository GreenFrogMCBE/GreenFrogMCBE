...
declare class ServerStartGamePacket extends PacketConstructor {
	 ...
	 */
	setDimension(new_dimension: { OVERWORLD: string; NETHER: string; END: string }): void;
	/**
	 * Sets the generator
	 * @param {Generator} new_generator - The generator
	 */
	setGenerator(new_generator: { OLD: number; INFINITE: number; FLAT: number; NETHER: number; END: number }): void;
	/**
