...
const Servertext_packet = require("../network/packets/Servertext_packet")
...
class Player {
	...
	constructor(
		...
		entity.set_spawn_y_coordinate(this.world.spawn_coordinates.y - 2)
	...
	send_message(message) {
		EventEmitter.emit(
			new Event(
				...
				(() => {
					const text_packet = new Servertext_packet()
