...
class ConsoleCommandSender {
  ...
  start() {
    ...
    r.on("line", (data) => {
        ...
        plugins.forEach((plugin) => {
          try {
            ...
            Logger.prototype.log(
              lang
                .failedtoexecuteonConsoleCommand()
      ...
      if (
        data.toLowerCase().startsWith(`${lang.command_time.toLowerCase()} `)
      ) {
      ...
      if (
        data.toLowerCase().startsWith(`${lang.command_kick.toLowerCase()} `)
      ) {
      ...
      switch (data.toLowerCase()) {
        ...
        case lang.command_stop.toLowerCase():
          if (!commands.console_command_stop) {
            Logger.prototype.log(lang.unknown_command);
            return;
          }
          ...
          try {
            for (let i = 0; i < PlayerInfo.prototype.getPlayers().length; i++) {
              PlayerInfo.prototype
                .getPlayers()
                [i].disconnect(lang.kick__servershutdown);
            }
          } catch (e) {}
          closed = true;
        ...
        case lang.command_plugins.toLowerCase():
          ...
          Logger.prototype.log(
            `${lang.plugins} (${plugins}): ${Colors.CONSOLE_PL_GREEN}${
        ...
        case lang.command_help.toLowerCase():
          ...
          if (commands.console_command_pl) {
            Logger.prototype.log(lang.pl_help);
          }
          if (commands.console_command_plugins) {
            Logger.prototype.log(lang.plugins_help);
          }
          break;
        default:
          Logger.prototype.log(lang.unknown_command);
