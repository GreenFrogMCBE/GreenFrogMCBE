...
declare function on(eventName: "generatorGeneratingWorld", listener: (...args: any[]) => void): void;
...
declare function on(eventName: "inventoryContainerGiveItem", listener: (...args: any[]) => void): void;
declare function on(eventName: "inventoryContainerItemRequest", listener: (...args: any[]) => void): void;
declare function on(eventName: "inventoryPreItemRequest", listener: (...args: any[]) => void): void;
declare function on(eventName: "inventoryPostItemRequest", listener: (...args: any[]) => void): void;
...
declare function on(eventName: "playerOpStatusChange", listener: (...args: any[]) => void): void;
